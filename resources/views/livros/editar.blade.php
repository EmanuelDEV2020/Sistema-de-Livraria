...
<html lang="pt-br">
    ...
    <body>
        ...
        @csrf
            <div><label for="isbn">Titulo</label>
            ...
            <div><label for="data_locacao">Data de Locaçao</label>
            <input type="text" name="data_locacao" id="data_locacao"  value="{{$livro->data_locacao}}"></div>
